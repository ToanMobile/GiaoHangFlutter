                ...
                Column(
                  children: [
                    Text('Chờ lấy',
                        ...
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1),
                    Text((item.choLayHang ?? 0).toString(),
                        style: text16.textColor141414,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1),
                  ],
                ...
                Column(
                  children: [
                    Text('Đã lấy',
                        ...
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1),
                    Text((item.daLayHang ?? 0).toString(),
                        style: text16.textColor141414,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1),
                  ],
                ...
                Column(
                  children: [
                    Text('Đang giao',
                        ...
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1),
                    Text((item.dangGiaoHang ?? 0).toString(),
                        style: text16.textColor141414,
                        overflow: TextOverflow.ellipsis,
                        maxLines: 1),
                  ],
